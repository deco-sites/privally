...
(function(permissions) {
    ...
    var generateBlockList = function(clear) {
        if(clear) permissions.b = [];
        ...
        listCookies.forEach(function(e) {
            ...
            if (isNoList(domain, name)) {
                permissions.b.push({domain, name});
            }
        })
    }
  
    var isNoList = function(domain, name) {
        return !permissions.b.find(function(item){
